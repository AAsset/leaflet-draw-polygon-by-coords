(function (window, document, undefined) {
    ...
    L.Control.ToolPanel = L.Control.extend({
        ...
        initActionBtn: function () {
            var actionBlock = L.DomUtil.create('div', 'draw-panel-action-block', this._container);
        ...
        checkCoordFields: function() {
            const arr = [].filter.call( this._coordFields, function( el ) {
                return el.value === ''
            });
            if (arr.length > 0) {
                return false;
